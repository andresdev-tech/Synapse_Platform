    ...
    content: (
      <div className="flex justify-center my-6 relative group">
        ...
        <ImageZoom 
          ...
          className="relative rounded-xl shadow-lg w-full max-w-7xl object-cover transform transition-transform duration-700 hover:scale-[1.02]"
          loading="eager"
          width={1200}
          height={675}
        />
    ...
    content: (
      <div className="flex justify-center my-6 relative group">
        ...
        <ImageZoom 
          ...
          className="relative rounded-xl shadow-lg w-full w-full object-cover bg-white p-4 transform transition-transform duration-700 hover:scale-[1.02]"
          loading="eager"
          width={1200}
          height={1063}
        />
    ...
    content: (
      <div className="space-y-10">
        <div className="flex flex-col gap-6 items-center">
          <ImageZoom 
            src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjfyG1rQRjJJ3OC40Q6zdQyLwXwF9ikZKVRLeghhXyafCl-urVl1wHrDLswugjQG3tFPVF0_pRLmMWkDymbkFAcjeN15KZY-zHQGtjVyUuVhuv61q1gzTQVjm2V5vIoJi0rdXD-WFIZ1pj6JofV16KW60U1GNicU0D6ggl0CLiieq1jK-lp-yTM7NzxbIpO/s800/Directorio.jpg" 
            alt="Directorio CTMA"
            className="rounded-xl shadow-md w-full max-w-7xl transform transition-transform duration-500 hover:scale-[1.01]"
            loading="lazy"
          />
          <ImageZoom 
            src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgzZN4cYrfFrX7TSAmlOCrd_a0_L8fC7J9OfgNox23Ws263VSgVs-Pj1lnSvtz1XQJHLm0Ingq33oN9v9BLXPmKA4cyBkJbG1DaSm4B_-KgNW0VqKqZTzZwYGXz2RXOjwUSjJLLBKe1dB70gkkfJzGyK2P-gvWQ1vlWKZkWlsq-vVhyphenhyphen0f_NzYjMS8FQ4bgs/s800/3.jpg" 
            alt="Contacto 1"
            className="rounded-xl shadow-md w-full max-w-7xl transform transition-transform duration-500 hover:scale-[1.01]"
            loading="lazy"
          />
          <ImageZoom 
            src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgchLU_EUuaaRzf0SqeUu7a2ffOze5zA5N_qpCI7f9CQqwD1iPmeRLCTmuUzaTfgdJ43GYbcTPfTnegmafgCJvFY6aos4W8WvzLAFcrmGkKkblWCxGWlEf3uufhTakCX028a6SkpF8e4pjddGx8_ABpgdrMbHWGWdib8RpvJlqzXEZODfhQPkiIgQnsfLEy/s800/5.jpg" 
            alt="Contacto 2"
            className="rounded-xl shadow-md w-full max-w-7xl transform transition-transform duration-500 hover:scale-[1.01]"
            loading="lazy"
          />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 w-full w-full mx-auto py-8">
        ...
        <div className="flex flex-col h-full bg-slate-100 dark:bg-slate-800/50 rounded-3xl p-6 shadow-sm border border-slate-200 dark:border-slate-700/50 hover:shadow-xl transition-all duration-300">
          ...
          <div className="mt-auto [&>div]:mt-0">
            <GalleryTrigger 
              coverImage="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgrVv0yJn32GZcyDDTAdb4g9uK6ojh2On3yUB-2Go1YB92_T8O9ANXL1eUsiPjCT25ootVgKAMkiNDojDP5KJ4Yv6VodYeTrowSd9gWD_8WWglnDgUQX5bWzQjO5w0HSfQx5K3FTsehdHMkKjAKb1pWqQ5Dzx3NEtkZO8AcRgOA9tnwdjJ5CxvHB-HVOY7_/s800/%C2%BFQu%C3%A9%20es%20la%20Etapa%20Productiva(2).jpg"
              title="Actividades Programadas"
              images={[
                "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEj

            />
          </div>
        </div>
        ...
        <div className="flex flex-col h-full bg-slate-100 dark:bg-slate-800/50 rounded-3xl p-6 shadow-sm border border-slate-200 dark:border-slate-700/50 hover:shadow-xl transition-all duration-300">
          ...
          <div className="mt-auto [&>div]:mt-0">
            <GalleryTrigger 
              coverImage="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhnr5z-fFY2KAf6u33XUEVO9exs3WUP9E5vEyGtReUppaTI-T_6sWio0EaUtL1tzV_y9Vu9ht4HLUv3y24emB57DEuQkx_vl7wxTk4QMpN_JMUTnTFJua-CmzxSFRVCR8bns5o5V4aouFZXyxjH3PHstcDcMVSJWDFxmFBAY1a9yq24oDrO6rqfRTF30ndW/s800/%C2%BFQu%C3%A9%20es%20la%20Etapa%20Productiva(1).jpg"
              title="Convocatorias Vigentes"
              images={[
                "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhi8pRmeAVAcFMYmq3z6LsVW5x0FHeaWbQLtQHiQqCO_fkH-12FG64tZ1HnepleQTfUYvZMqY6Amz1oeERgKPYHJjJZIYEXGY6eryKI9SOK45LISKy06yEd9X61-lrFYHKCd3XVyeWfrs8cBMTEyt_1F3wtSnCIUkRvLPt0x-qi4Y00QzRcUZymKS3imzbv/s800/CONVOCATORIA_2026.jpg",
                "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgE8Ic1eu8cP4YqWeW8VneUcjGC9Hsq6KFmr4MSuTlMKRUVQtR-jheO179pokcdBXkuGryIW7gskg5yJxVk3-PDKJL_kL8ctXfyBt3W2IQjLx9NKNq6H6uqqTffQy8TGPUdufSs-0Wqw-u-7sGsJ9z4iwtw1j0WftrfFTfh8NrrvSxAGTA6R66RMRx8Gs_R/s800/Del%2029%20de%20enero%20al%204%20de%20febrero.jpg"
              ]}
            />
          </div>
        </div>
        ...
        <div className="flex flex-col h-full bg-slate-100 dark:bg-slate-800/50 rounded-3xl p-6 shadow-sm border border-slate-200 dark:border-slate-700/50 hover:shadow-xl transition-all duration-300">
          ...
          <div className="mt-auto [&>div]:mt-0">
            <GalleryTrigger 
              coverImage="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgoMShYNvdJlBW8q36TLsv-6t68n2VBcRyksI2MM3zoW3BcKpEoHi2INGz2Y1hle2o-3_tKkQeZH-WcRUxw-dUlGF1O57-frXO9KUaoddgIulnN_0CtsVMwVP9pXlWMkZ8Pu_CUWFxA0gDK9GQVdNQ7uSxxPLKNwSJ_nPWVqLZVIQtVz9t7_M5s03E6FZIv/s800/%C2%BFQu%C3%A9%20es%20la%20Etapa%20Productiva(3).jpg"
              title="Servicios y Póliza"
              images={[
                "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgpALoSvl0MT3imG5AC-2yZ7ko2qg9ZMvFIVJqTYldWloAfpD_OlJ-ra0tavfHuDh_p0KhdSA23EZO5fdUFJd8x8R_6HDgOJw-0kRAgSODDz0HtSKUyfnUv_-v8tRDDt_sEPjRqjPlnt9cZjIvoDPyqIckJJlD2MWsCxg7sc1beQIQ2KegogvH1-O8R_WDJ/s800/p%C3%B3liza.jpg",
                "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhz35CBWkoKxNS-NOjoU-8HVv-g_ZMzN0bsOHLq5T-F2AJPhsrqcrwtICNXi37zz_HbR1JrHqrZhoZDtS9SKxH36oeYm520WsWynLyjk4NEVvv53ThjgjESWwiaVGsr--rI5BG3fJeyXIC-DymTyzp9Mgm9ScqUmMAJC3QDN8_pw7NUb-vr0GsRIHR0/s800/Bienestar_pages-to-jpg-0011.jpg",
                "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgYBi3ZBIB8rV3u2tm-svrmwr27g5H4b13Gxz3j6x6C9r23aoDP-F-jHzTVnD4WMaqa32pKaxyheCsEcp7HYj_G5nyJMozwAarOu2crCHJkdOx7xKq-HAZABxh6J1FFWvzMdrCPaXDnWd1cuaasPbAxxxnNQTdVVfya3tUwsxabVDuVr_dYaGBaaNAb/s800/Bienestar_pages-to-jpg-0008.jpg",
                "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgoTfWRY-gNaxCOKb0aixkixutrNg8aOoBsZDWF-HFI-1SbI9wPNNzAFtidNuk_kX-xN_inzYpaFtdZtZL7BiFL07DdrMN-Er0Uoctg_ytcZEIS0Jdyd4DIW0BsA-vq9Q9IUmJpoj_bvtNQbERAq8PrL4-B8Sfzv9IGe6TSUE_PUtjVjAWNvI57gbwm/s800/Bienestar_pages-to-jpg-0013.jpg",
                "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjJv9EF7haZl5UXW4ISt58gyBkbzWV_GVvauwkFKI743mwFvCwk_mmROORVM4Y9_4rX6s3xVOtoBmLawPum7inJecU6_oaIL7ZQyq5U7lEkALEU4Ts6Kc796g1dNQoVhQZOPhcdjSKYsMO_bFbysmqZGtYaKvVG-SVtmJpjrG_yxukwzlYY8c_ygBYy/s800/Bienestar_pages-to-jpg-0014.jpg"
              ]}
              extraContent={
                <a 
        ...
        <div className="flex flex-col h-full bg-slate-100 dark:bg-slate-800/50 rounded-3xl p-6 shadow-sm border border-slate-200 dark:border-slate-700/50 hover:shadow-xl transition-all duration-300">
          ...
          <div className="mt-auto [&>div]:mt-0">
            <GalleryTrigger 
              coverImage="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiJi0-KPjeSYTOaStRi01yk8eRdz720agccAabsKUEnWy_bOriNGnYhsKJJA_UX7QskTc2SFOINgOi06FXC01pFlXQe5l-j1c-QpGD_s50hlnVUfeV-nJaRWfV1McJZMRMfaeiGnYdwKcsUMZnGk883Q6egVDeSzLKZHgCby76kwK6SSqRVtVJo2w3BXeS4/s800/%C2%BFQu%C3%A9%20es%20la%20Etapa%20Productiva(5).jpg"
              title="Información Adicional de Bienestar"
              images={[
                "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgS9U_FWP-rNQ3cGKJvh_6diND-yCF2y5hubI1JkedZgDjmpdN4B0JDlpP1cjd6bWjzLBlAZ8wRyH33u6SZ5hTFXQXIOZgtr-U0ainEI-n8hHpspRVo81O4mpeqnnBDmIrSW5Dy1l0UEd6lnV4VvD6bWu0XfDWh7J4oYWjRAhndLgNCyf_tAkYcwSWV/s800/Bienestar_pages-to-jpg-0003.jpg",
                "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjQUr2dF9fy4Te3ZqMx_CNqT1oi8tLXgTyl0lTcKp72Gymv6J9wICdjcCIaElNk_ZSZEnGr85orMuc6OKvyFaSH9KkoSoesI7rhBYcLA_Vt-TaMphBfjlaraLRYfYXKci_kVy33kFNUL4xgJfyFcFOJlmGW-Hz-FBPUbHnKvElPxH0bOC3m4_e4MtKV/s800/Bienestar_pages-to-jpg-0004.jpg",
